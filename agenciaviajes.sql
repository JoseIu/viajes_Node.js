...
INSERT INTO `testimonios` (`id`, `nombre`, `email`, `mensaje`) VALUES
(6, 'joselu', 'joselu@gamil.com', 'La mejor página web que he visto en mi vida, mis dieses :DD');
INSERT INTO `testimonios` (`id`, `nombre`, `email`, `mensaje`) VALUES
(7, 'Carlos', 'carlos@gmail.com', 'Hola k ase');
INSERT INTO `testimonios` (`id`, `nombre`, `email`, `mensaje`) VALUES
(8, 'Vincent', 'vincent@gmail.com', 'Hola soy un gato en un pc');
